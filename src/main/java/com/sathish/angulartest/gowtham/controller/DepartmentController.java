...
public class DepartmentController {
	...
	@PostMapping("/add")
	public String addReq(@RequestBody Department dep_body) {
		return depserv.addReq(dep_body);
	}
	
	@PutMapping("/update")
	public String updatereq(@RequestBody Department dep_body) {
		return depserv.updatereq(dep_body);
	}
	
	@DeleteMapping("/delete/{dep_id}")
	public String deletereq(@PathVariable int dep_id) {
		return depserv.deletereq(dep_id);
	}
